  ...
  return (
    <section className="max-w-7xl mx-auto text-[32px]">
      ...
      <form className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
        ...
        <div className="mt-10">
              <p className="mt-2 text-lighttext text-[14px]">Once you have created the image you want, you can share it with others in our community</p>
              <button
                type="submit"
                className="mt-3 text-white bg-highlight font-medium rounded-md text-sm w-full sm:w-auto px-5 py-2.5 text-center"
              >
